...
# Paths and variables
dir="/path/to/SNPcalling"
reference="/path/to/data/idCulPipi.chrom.fa"
population_file="/path/to/SNPcalling/populations-mpileup.txt"  # File with population information
